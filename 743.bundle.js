(self.webpackChunkreact_starter_split_webpack_5_ts = self.webpackChunkreact_starter_split_webpack_5_ts || []).push([ [ 743 ], {
    868: function(module, __unused_webpack_exports, __webpack_require__) {
        ...
        })(obj, "symbol" != typeof key ? key + "" : key, value), value), Vimeo_exports = {};
        ((target, all) => {
            ...
            default: () => Vimeo
        }), module.exports = (mod = Vimeo_exports, __copyProps(__defProp({}, "__esModule", {
            value: !0
        }), mod));
        ...
        const cleanUrl = url => url.replace("/manage/videos", "");
        class Vimeo extends import_react.Component {
            ...
            load(url) {
                this.duration = null, (0, import_utils.getSDK)("https://player.vimeo.com/api/player.js", "Vimeo").then((Vimeo2 => {
                    if (!this.container) return;
                    const {playerOptions: playerOptions, title: title} = this.props.config;
                    this.player = new Vimeo2.Player(this.container, {
                        ...
                        iframe.style.width = "100%", iframe.style.height = "100%", title && (iframe.title = title);
                    ...
                    })), this.player.on("pause", this.props.onPause), this.player.on("seeked", (e => this.props.onSeek(e.seconds))), 
                    this.player.on("ended", this.props.onEnded), this.player.on("error", this.props.onError), 
                    this.player.on("timeupdate", (({seconds: seconds}) => {
                        this.currentTime = seconds;
                    })), this.player.on("progress", (({seconds: seconds}) => {
                        this.secondsLoaded = seconds;
                    })), this.player.on("bufferstart", this.props.onBuffer), this.player.on("bufferend", this.props.onBufferEnd), 
        ...
        __publicField(Vimeo, "displayName", "Vimeo"), __publicField(Vimeo, "canPlay", import_patterns.canPlay.vimeo), 
        __publicField(Vimeo, "forceLoad", !0);
    }
} ]);