(self.webpackChunkreact_starter_split_webpack_5_ts = self.webpackChunkreact_starter_split_webpack_5_ts || []).push([ [ 546 ], {
    993: function(module, __unused_webpack_exports, __webpack_require__) {
        ...
        })(obj, "symbol" != typeof key ? key + "" : key, value), value), Streamable_exports = {};
        ((target, all) => {
            ...
            default: () => Streamable
        }), module.exports = (mod = Streamable_exports, __copyProps(__defProp({}, "__esModule", {
            value: !0
        }), mod));
        ...
        class Streamable extends import_react.Component {
            ...
            load(url) {
                (0, import_utils.getSDK)("https://cdn.embed.ly/player-0.1.0.min.js", "playerjs").then((playerjs => {
                    this.iframe && (this.player = new playerjs.Player(this.iframe), this.player.setLoop(this.props.loop), 
                    this.player.on("ready", this.props.onReady), this.player.on("play", this.props.onPlay), 
                    this.player.on("pause", this.props.onPause), this.player.on("seeked", this.props.onSeek), 
                    this.player.on("ended", this.props.onEnded), this.player.on("error", this.props.onError), 
                    this.player.on("timeupdate", (({duration: duration, seconds: seconds}) => {
                        this.duration = duration, this.currentTime = seconds;
                    })), this.player.on("buffered", (({percent: percent}) => {
                        this.duration && (this.secondsLoaded = this.duration * percent);
        ...
        __publicField(Streamable, "displayName", "Streamable"), __publicField(Streamable, "canPlay", import_patterns.canPlay.streamable);
    }
} ]);