(self.webpackChunkreact_starter_split_webpack_5_ts = self.webpackChunkreact_starter_split_webpack_5_ts || []).push([ [ 125 ], {
    2648: function(module, __unused_webpack_exports, __webpack_require__) {
        ...
        })(obj, "symbol" != typeof key ? key + "" : key, value), value), SoundCloud_exports = {};
        ((target, all) => {
            ...
            default: () => SoundCloud
        }), module.exports = (mod = SoundCloud_exports, __copyProps(__defProp({}, "__esModule", {
            value: !0
        }), mod));
        ...
        class SoundCloud extends import_react.Component {
            constructor() {
                ...
                __publicField(this, "fractionLoaded", null), __publicField(this, "mute", (() => {
                    this.setVolume(0);
            ...
            load(url, isReady) {
                (0, import_utils.getSDK)("https://w.soundcloud.com/player/api.js", "SC").then((SC => {
                    if (!this.iframe) return;
                    const {PLAY: PLAY, PLAY_PROGRESS: PLAY_PROGRESS, PAUSE: PAUSE, FINISH: FINISH, ERROR: ERROR} = SC.Widget.Events;
                    isReady || (this.player = SC.Widget(this.iframe), this.player.bind(PLAY, this.props.onPlay), 
                    ...
                    })), this.player.bind(FINISH, (() => this.props.onEnded())), this.player.bind(ERROR, (e => this.props.onError(e)))), 
                    this.player.load(url, {
                        ...this.props.config.options,
                        callback: () => {
                            this.player.getDuration((duration => {
                                this.duration = duration / 1e3, this.props.onReady();
                            }));
                        }
                    });
                }));
            ...
            seekTo(seconds, keepPlaying = !0) {
                this.callPlayer("seekTo", 1e3 * seconds), keepPlaying || this.pause();
            }
            setVolume(fraction) {
        ...
        __publicField(SoundCloud, "displayName", "SoundCloud"), __publicField(SoundCloud, "canPlay", import_patterns.canPlay.soundcloud), 
        __publicField(SoundCloud, "loopOnEnded", !0);
    }
} ]);